function [grad_ter,grad_ter_Ind_x0,hess_ter_Ind_x0] = ...
    ter_set_Ind_fun(mpc,x_ref,s_ter,fi_ter_x0,ter_constraint)

% Gradient of Terminal Set Constraint
grad_ter = mpc.P2*(x_ref-s_ter); % grad_ter = -2*I*P*x_err -> negative I to be considered 
...
grad_ter_Ind_x0_sub = [grad_ter / fi_ter_x0;
                       1 / fi_ter_x0];
...
hess_ter_Ind_x0_sub(1:mpc.nx, 1:mpc.nx) = ...
    hess_ter_Ind_x0_sub(1:mpc.nx, 1:mpc.nx) - mpc.P2 / fi_ter_x0;
